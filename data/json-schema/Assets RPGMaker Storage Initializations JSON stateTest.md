# JSON schema: Assets RPGMaker Storage Initializations JSON stateTest
...
* 😁 `#ROOT#` array
    ...
    * 😁 `id` property
        * examples:
            ...
            >    "5fe624d0-f534-438a-ad9c-412b30e9f61f",
    ...
    * 😁 `message1` property
        * examples:
            ...
            >    "%1 was charmed!",
            >    "%1 fell asleep!",
            >    "%1 was paralyzed and cannot move!",
