...
# Unity プロジェクトの 2D テンプレートを作成しようぜ？

![202307_rmu_03-2203--unity-2d-project.png](https://crieit.now.sh/upload_images/0aca864283320added26d60ca6f926dd64a2cd5136bc5.png)  

![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　👆　ＲＭＵは　Ｕｎｉｔｙの上で動くから、  
Ｕｎｉｔｙプロジェクトを　２Ｄ　テンプレートを選んで作成しておこうぜ。  
上図左下を見ての通り、けっこう色々　最初から載っているぜ」  

![202307_rmu_03-2206--unity-2d-project.png](https://crieit.now.sh/upload_images/37c59d5aac58e6fa14d900eaa25480f064a2cdaa571b1.png)  

![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　👆　このＵｎｉｔｙプロジェクトだけで　**1.22 GB**　ほどあるぜ」  
...
## インポート後、 2.25 GB ＋ 約 10 GB（含む 1.22 GB）
...
📺　[https://www.youtube.com/watch?v=9--Q6I57w_4](https://www.youtube.com/watch?v=9--Q6I57w_4)  
...
![202306_rmu_17-1436--faces.png](https://crieit.now.sh/upload_images/76e79e301d88075405256c68c26940cd648d46b9db0c4.png)  
...
![202306_rmu_17-2308--Switch-Button.png](https://crieit.now.sh/upload_images/a57706cbbb70cb0b7ba84538472b28c6648dbe661ec8c.png)  
...
![202306_rmu_17-2311--Vehicle.png](https://crieit.now.sh/upload_images/8617a4da4af2a80938148df578ed24ac648dbf4f77f8c.png)  
...
![kifuwarabe-futsu.png](https://crieit.now.sh/upload_images/beaf94b260ae2602ca8cf7f5bbc769c261daf8686dbda.png)  
「　それより　昔のＲＰＧツクールの　キャラクターの　左向き、右向きとか  
１枚の画像に　まとまってなかったか？」  
...
![ohkina-hiyoko-futsu2.png](https://crieit.now.sh/upload_images/96fb09724c3ce40ee0861a0fd1da563d61daf8a09d9bc.png)  
「　ＲＭＵのファイル構成には、システマチックな規則性が　有ったり無かったり　するのよねえ」  

### 📂 Objects - Waterref

![202306_rmu_18-0422--WaterRef.png](https://crieit.now.sh/upload_images/ba6e018ef8fc37718a470e8cde0e6c0d648e08455efb4.png)  
...
![202306_rmu_18-0427--Weapon.png](https://crieit.now.sh/upload_images/f2a989378e2337e262f1ea7ab9bfcd10648e0a1702e96.png)  
...
![202306_rmu_18-0438--World.png](https://crieit.now.sh/upload_images/866e93e594dc642c375d5cba1be1049e648e0be7afeaf.png)
...
![202306_rmu_18-0515--Parallaxes.png](https://crieit.now.sh/upload_images/471ed9386c43c6cbb36a2bb2bf6f032d648e149fa956c.png)  
...
![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　立体画像かな、と思って　じっと　眺めてみたりした」  

![kifuwarabe-futsu.png](https://crieit.now.sh/upload_images/beaf94b260ae2602ca8cf7f5bbc769c261daf8686dbda.png)  
「　ググると　ＲＰＧツクールＶＸ　が出てくる」  
...
なんで　📂 `Images` フォルダーの中に 📂 `Pictures` が有るの？」
...
![kifuwarabe-futsu.png](https://crieit.now.sh/upload_images/beaf94b260ae2602ca8cf7f5bbc769c261daf8686dbda.png)  
「　📂 `Pictures` フォルダーには　何の絵が入ってるんだぜ？」  

![ohkina-hiyoko-futsu2.png](https://crieit.now.sh/upload_images/96fb09724c3ce40ee0861a0fd1da563d61daf8a09d9bc.png)  
「　額縁に入ってる絵かなあ？」  

![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　それだったら　📂 `Map Decorations of House` フォルダーとかに入れたい」  

![ohkina-hiyoko-futsu2.png](https://crieit.now.sh/upload_images/96fb09724c3ce40ee0861a0fd1da563d61daf8a09d9bc.png)  
「　では　ＲＭＵ　の　📂 `Pictures`　フォルダーの中身を見てみましょう」  

![202306_rmu_18-0608--StandingPose.png](https://crieit.now.sh/upload_images/1b910dc1afb89c793f7bd22a28b729d7648e20e9c5a0a.png)  

![kifuwarabe-futsu.png](https://crieit.now.sh/upload_images/beaf94b260ae2602ca8cf7f5bbc769c261daf8686dbda.png)  
「　ポートレート（Portrait；肖像画）だ」  
...
![ohkina-hiyoko-futsu2.png](https://crieit.now.sh/upload_images/96fb09724c3ce40ee0861a0fd1da563d61daf8a09d9bc.png)  
「　👆　📂 `Character Standing`　に入れたいわねえ」

![kifuwarabe-futsu.png](https://crieit.now.sh/upload_images/beaf94b260ae2602ca8cf7f5bbc769c261daf8686dbda.png)  
「　ツクラーが嫌がるんじゃないか？」  

![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　ＲＰＧを作るエディターを調べているというより、  
**Ｔｈｅ**　ＲＰＧ　Ｍａｋｅｒ　Ｕｎｉｔｅ　を調べている感じだよな」  

## 📂 SV_Actors

![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　では、次に　📂 `SV_Actors` （エス・ブイ・アクターズ）フォルダーの中身を見ていこうぜ？」  

![ohkina-hiyoko-futsu2.png](https://crieit.now.sh/upload_images/96fb09724c3ce40ee0861a0fd1da563d61daf8a09d9bc.png)  
「　ＳＶって　何なのよ！」  

![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　👇　サイド・ビュー（Side View；横視点）だぜ」  

📖 [公式　＞　RPG Maker Unite 初心者講座　＞　主人公アクターの設定　＞　アクターを作ろう](https://rpgmakerunite.com/learn/002.html#01)  

![202306_rmu_18-0653--SVActor.png](https://crieit.now.sh/upload_images/db674ce5bbd5c26ee91184f966b32e56648e2b88a7dcf.png)

![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　ＲＭＵでは　バトラー（Battler；戦う人）という用語も　推したいようだな」  

![ohkina-hiyoko-futsu2.png](https://crieit.now.sh/upload_images/96fb09724c3ce40ee0861a0fd1da563d61daf8a09d9bc.png)  
「　📂 `Battle Characters - Side View` というフォルダー名にしたらダメなの？」  
...
![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　昔、サラリーマンを辞めて　格闘ゲームを自作しようとして　１体のキャラを描こうとして  
１か月　ドット絵を打っても　ちっとも終わらないんで　結局、サラリーマンに再就職したことがある」  
...
![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　次に　📂 `System` （システム）フォルダーの中身を見ていくが、  
テレスドン　している」  

![kifuwarabe-futsu.png](https://crieit.now.sh/upload_images/beaf94b260ae2602ca8cf7f5bbc769c261daf8686dbda.png)  
「　テレスドンを　悪い意味で使うなだぜｗｗｗｗｗ」  

![ohkina-hiyoko-futsu2.png](https://crieit.now.sh/upload_images/96fb09724c3ce40ee0861a0fd1da563d61daf8a09d9bc.png)  
「　では　ＲＭＵ　の　📂 `System` ディレクトリーの中身を見てみましょう」  

![202306_rmu_18-0715--SystemFolder.png](https://crieit.now.sh/upload_images/347848f7c7e46299b7f47d69b914ec34648e30a8ad018.png)  
...
![202306_rmu_18-0735--System-arrow.png](https://crieit.now.sh/upload_images/ef042313cb4cf1c258f2e115a11ae764648e352acb852.png)  

![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　👆　📄 `arrow` ファイルは、下向きの　アロー（Arrow；矢印）だぜ」  
...
勝手に　📂 `HUD Camp Menu`　放り込んでおいてくれるんじゃないの？」  
...
![202306_rmu_18-0820--System-baloon.png](https://crieit.now.sh/upload_images/7c3ad70136043d818e25d19e52553e28648e3fd789e1b.png)  

![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　👆　📄 `Balloon` ファイルは、バルーン（Balloon；吹出し）だぜ。  
...
📂 `Map Characters` に入れるよう指示したらどうだぜ？」  

![kifuwarabe-futsu.png](https://crieit.now.sh/upload_images/beaf94b260ae2602ca8cf7f5bbc769c261daf8686dbda.png)  
「　Gotcha Gotcha Games は　バルーンを　`System`　だと思っていて、  
お父んは　バルーンを　`Map Characters`　だと思うのは  
どういう違いから　そう分かれてしまったと思うかだぜ？」  

![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　向こうさんは　ゲーム・システム　だと思ってんじゃないか？  
感情表現のバルーンが出てくるシステムですよ、みたいな。  
そんな考えをしていたら　多くの物が　📂 `System`　フォルダーの下に　詰め込まれてしまうだろう」  
...
![202306_rmu_18-0827--System-ButtonSet.png](https://crieit.now.sh/upload_images/ad56d700336be8e2d46a5065e12b33c2648e416480328.png)

![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　👆　📄 `ButtonSet` ファイルは、ボタンだぜ。
上だの　下だの　戻るだの、ハンバーガー・メニューだの」  

![kifuwarabe-futsu.png](https://crieit.now.sh/upload_images/beaf94b260ae2602ca8cf7f5bbc769c261daf8686dbda.png)  
「　タイル・セット状にしておいてくれれば　ファイル１枚に収まるのだから、  
タイル・セット状にしておいて欲しいよな、歩行キャラクター画像とか」  

![ohkina-hiyoko-futsu2.png](https://crieit.now.sh/upload_images/96fb09724c3ce40ee0861a0fd1da563d61daf8a09d9bc.png)  
「　📂 `System` フォルダーの下は　感覚的には　まともね」  

![ramen-tabero-futsu2.png](https://crieit.now.sh/upload_images/d27ea8dcfad541918d9094b9aed83e7d61daf8532bbbe.png)  
「　Gotcha Gotcha Games には　まともには　見えてないんだろ。  
やり残したことがある……、 📂 `System` フォルダーの下の画像も　ばらばらに分解せねば……、  
とか思っていて　次のバージョン更新で　　
ボタンも１つずつ　ばらばらのファイルになってるかも知れないぜ？」  
